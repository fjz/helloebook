...
public class MyMath {
	 ...
	 * @return
	 */
	public static MyMath initLine(float x1,float y1,float x2,float y2){
		MyMath mnLine = new MyMath();
	 ...
	 * @return
	 */
	public MyMath getPBLine(float bx,float by){
		MyMath line = new MyMath();
		line.a = -1/this.a;
		line.b = by-line.a*bx;
		return line;
	}
	 ...
	 * @return
	 */
	public PointF getCross(MyMath line){
	 ...
	 * @return 平移后的直线方程。
	 */
	public MyMath LineTranslationWidthDistance(float distance,boolean direction)
	{
		MyMath l = new MyMath();
		l.a = this.a;
		if(direction)
